...
// import { updateInvoiceStatus } from '../../utils/apiClient';
...
//     try {
//       const allParts = await getSparePartRequests(service.vehicle.id, service.createdAt);
//       const relatedParts = allParts
//         .filter((part: SparePartRequest) => 
//           part.status === 'Approved' &&
//           part.vehicleId === service.vehicle.id &&
//           new Date(part.createdAt).toISOString().split('T')[0] === 
...
//       dispatch({
//         type: 'SET_INVOICES',
//         payload: invoices.map(inv => inv.id === selectedInvoice.id ? { ...inv, status: selectedInvoice.status } : inv)
//       });
...
//                         payload: { ...selectedInvoice, status: e.target.value as string },
//                       })
//                     }
//                   >
